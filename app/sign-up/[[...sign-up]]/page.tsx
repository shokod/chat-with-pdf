  ...
  return (
    <div className="grid w-full flex-grow items-center bg-white px-4 sm:justify-center">
      <SignUp.Root>
        <SignUp.Step
          name="start"
          className="w-full space-y-6 rounded-2xl border shadow-lg bg-white bg-[radial-gradient(circle_at_50%_0%,theme(colors.fuchsia.50),transparent)] px-4 py-10 ring-1 ring-inset ring-fuchsia/5 sm:w-96 sm:px-8"
        >
          <header className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 40" className="mx-auto size-10">
              <mask id="a" width="40" height="40" x="0" y="0" maskUnits="userSpaceOnUse">
                <circle cx="20" cy="20" r="20" fill="#aa08" />
              </mask>
            ...
            <h1 className="mt-4 text-xl font-medium tracking-tight text-slate-800">Create an account</h1>
          </header>
          <Clerk.GlobalError className="block text-sm text-red-400" />
          <div className="space-y-4">
            <Clerk.Field name="emailAddress" className="space-y-2">
              <Clerk.Label className="text-sm font-medium text-slate-800">Email address</Clerk.Label>
              <Clerk.Input
                type="text"
                required
                className="w-full rounded-md px-3.5 py-2 text-sm text-white outline-none ring-1 ring-inset ring-blue-400 hover:ring-fuchsia-600 focus:bg-transparent focus:ring-[1.5px] focus:ring-blue-400 data-[invalid]:ring-red-400"
              />
            ...
            <Clerk.Field name="password" className="space-y-2">
              ...
              <Clerk.Input
                type="password"
                required
                className="w-full rounded-md  px-3.5 py-2 text-sm text-white outline-none ring-1 ring-inset ring-blue-00 hover:ring-fuchsia-600 focus:bg-transparent focus:ring-[1.5px] focus:ring-blue-400 data-[invalid]:ring-red-400"
              />
              <Clerk.FieldError className="block text-sm text-red-400" />
            </Clerk.Field>
          </div>
          <SignUp.Action
            submit
            className="relative isolate w-full rounded-md bg-slate-900 px-3.5 py-1.5 text-center text-sm font-medium text-white shadow-[0_1px_0_0_theme(colors.white/10%)_inset,0_0_0_1px_theme(colors.white/5%)] outline-none before:absolute before:inset-0 before:-z-10 before:rounded-md before:bg-white/5 before:opacity-0 hover:before:opacity-100 focus-visible:outline-[1.5px] focus-visible:outline-offset-2 focus-visible:outline-blue-400 active:text-white/70 active:before:bg-black/10"
          >
            Sign Up
          </SignUp.Action>
          <p className="text-center text-sm text-slate-400">
            ...
            <a
              href="#"
              className="font-medium text-slate-500 decoration-slate/20 underline-offset-4 outline-none hover:underline focus-visible:underline"
            >
              Sign in
            </a>
          </p>
